...
class SoovTest(BaseTester):
    ...
    def start(self, url: str):
        test_functions = [
            self.test_product_active_status,
    ...
    def test_product_active_status(self, soup):
        active_status = self.parser.get_product_active_status(soup)
        self.print_key_value("Active Status", active_status)
